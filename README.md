...
<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&size=18&duration=3000&pause=1000&color=50FFFF&center=true&vCenter=true&multiline=true&repeat=true&width=600&height=80&lines=Building+browser-native+tools+that+talk+to+blockchains;No+backend+%C2%B7+No+API+keys+%C2%B7+No+framework;Just+vanilla+JS%2C+RPC+nodes%2C+and+async+debugging;Always+learning+%C2%B7+Always+shipping+%C2%B7+Open+to+new+challenges;Web3+is+the+focus+%E2%80%94+but+not+the+ceiling" alt="Typing SVG" /></a>
